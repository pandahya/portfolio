...
let modeText;
if (
    document.documentElement.getAttribute("color-mode") == "paper" ||
    currentMode == "paper"
) {
    document.documentElement.setAttribute("color-mode", "paper");
    modeText = "you are in paper mode → switch to pixel mode";
} else if (
    document.documentElement.getAttribute("color-mode") == "pixel" ||
    currentMode == "pixel"
) {
        ...
        <React.Fragment>
            <ul id="navbar">
                ...
                <button className="hamburger" onClick={() => openMenu()}>
                    ...
                    >
                        <path
                            d="M0 0H20V3.33333H0V0ZM0 8.33333H20V11.6667H0V8.33333ZM20 16.6667H0V20H20V16.6667Z"
                            fill="white"
                        />
                    </svg>
                </button>
...
function Footer() {
    const switchModes = () => {
        if (document.documentElement.getAttribute("color-mode") == "paper") {
            ...
            document.getElementById("screenMode").innerHTML =
                "you are in pixel mode &rarr; switch to paper mode";
            ...
            document.documentElement.setAttribute("color-mode", "paper");
            document.getElementById("screenMode").innerHTML =
                "you are in paper mode &rarr; switch to pixel mode";
    ...
    return (
        <React.Fragment>
            <li>
                <button id="screenMode" onClick={() => switchModes()}>
                    {modeText}
                </button>
            </li>
            <li id="timestamp">Last updated: 6 Oct 2023</li>
